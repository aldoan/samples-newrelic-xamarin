...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "NewRelicXamarinSamples.Android.dll" comes first in this list. */
		"NewRelicXamarinSamples.Android.dll",
		"FormsViewGroup.dll",
		"NewRelicXamarin.Android.dll",
		"NewRelicXamarinSamples.dll",
